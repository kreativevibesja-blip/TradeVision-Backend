...
export const config = {
  ...
  gemini: {
    ...
    freeModel: process.env.GEMINI_FREE_MODEL || process.env.GEMINI_MODEL || 'gemini-3.1-flash-lite',
    proModel: process.env.GEMINI_PRO_MODEL || 'gemini-3-flash-preview',
    model: process.env.GEMINI_FREE_MODEL || process.env.GEMINI_MODEL || 'gemini-3.1-flash-lite',
  },
